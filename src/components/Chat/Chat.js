import React, { useEffect, useRef, useState } from "react"; //Importing React is not needed
...
export default function Chat() {
  ...
  useEffect(() => {
    if (socket && user) {
      ...
      console.log(clientPublicKey); //Remove console log
      ...
      socket.on("handshak", ({ serverPublicKey }) => {
        ...
        console.log(secretKey); //Remove console log
